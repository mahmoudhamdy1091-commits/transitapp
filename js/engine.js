...
async function je_opex({sys,date,amount,expType,desc,method,refNo}) {
  ...
  const OPEX_ACC_MAP = {
    'رواتب وأجور':          '6100',
    'إيجار مكتب / معرض':    '6200',
    'كهرباء وماء ومرافق':   '6300',
    'مصاريف إدارية':        '6400',
    'تسويق وإعلانات':       '6500',
    'عمولات ووساطة':        '6510',
    'ضيافة ومطاعم':         '6520',
    'رسوم حكومية ورخص':     '6610',
    'نظافة وصيانة':         '6700',
    'مصاريف متنوعة':        '6700',
    // احتياطي للبيانات القديمة
    'رواتب':'6100','إيجارات':'6200','عمولات':'6510',
    'نظافة':'6700','ضيافة':'6520','مصروفات حكومية':'6610','أخرى':'6700',
  };
